      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "row" }}>
          ...
          {isSetting && !isThirdPerson ? (
            ...
            >
              <EditSharpIcon style={{ color: "#DF922B" }} />
            </IconButton>
          ) : (
            <></>
          )}
        ...
        >
          ...
          <Grid item xs={3}>
            ...
            <MyTooltip title={window.web3.utils.fromWei(spentBought.toString())} arrow>
              <Typography variant="h5" className={classes.numberTextStyle}>
                {window.web3.utils.fromWei(spentBought.toString()).slice(0,4)} BNB
              </Typography>
            </MyTooltip>
            <Typography variant="h5">Earned</Typography>
            <MyTooltip title={window.web3.utils.fromWei(earnedSold.toString())} arrow>
              <Typography variant="h5" className={classes.numberTextStyle}>
                {window.web3.utils.fromWei(earnedSold.toString()).slice(0,4)} BNB
              </Typography>
            </MyTooltip>
          </Grid>
          <Grid item xs={4}>
          ...
          <>
            <div style={{ display: "flex", flexDirection: "row" }}>{/*  */}
              <MyTooltip title={window.web3.utils.fromWei(profileData.userBalance.toString())} placement="top" arrow>
                <Typography>Balance: {window.web3.utils.fromWei(profileData.userBalance.toString()).slice(0, 4)} BNB</Typography>
              </MyTooltip>
            </div>
            <div style={{ display: "flex", flexDirection: "row" }}>
              <TextField
        ...
        <Grid item xs={8}>
          ...
          >
            <Avatar
              ...
              variant="square"
              alt="empty"
              src="https://ipfs.io/ipfs/QmdtEQpDrpkAEY96aiW42UnbXaLPh5reZcFVKsGZ5waKoK"
              className={classes.large}
              key="gorkem"
            />
            {heads.map((item) => (
          ...
          >
            <Avatar
              ...
              variant="square"
              alt="empty"
              src="https://ipfs.io/ipfs/QmXjE91bZT7nELMow3wQ1UA81KjRio6YL7zDQnVsZT4pgw"
              className={classes.large}
              key="gorkem 2"
            />
            {middles.map((item) => (
          ...
          >
            ...
            <Avatar
              ...
              variant="square"
              alt="empty"
              src="https://ipfs.io/ipfs/QmRBsVRAHkrWmM64EubhzzgabtCaXeihihYnR1C2LXePm8"
              className={classes.large}
              key="gorkem 3"
            />
